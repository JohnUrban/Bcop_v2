...
## GREP BED NAME
BED=/mnt/sequence/jurban/bcop_v2_paper/hic/analyses/Bcop_v2/XO/q0/rerun-20240122/BcTPS-support/indiv/input/final-BcTPS-models.BcTPS-1.bed
...
bash ${RUN} ${LINKS} ${BED} ${G} ${BINSIZE} ${OUTPRE} ${PSEUDOCOUNT}
