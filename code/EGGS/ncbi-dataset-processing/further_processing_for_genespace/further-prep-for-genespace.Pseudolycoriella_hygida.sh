...
grep.py -f ${BASE}.OCLinput.tsv -c 4 -p  ${BASE}.forGenespace.names.txt -C 1  | translateTable.py -i - -c 4 -d ${TRANS} -k 1 -v 2 | translateTable.py -i - -c 1 -d chr2acc.ALT.tsv -k 2 -v 1 --force > ${BASE}.forGenespace.bed
