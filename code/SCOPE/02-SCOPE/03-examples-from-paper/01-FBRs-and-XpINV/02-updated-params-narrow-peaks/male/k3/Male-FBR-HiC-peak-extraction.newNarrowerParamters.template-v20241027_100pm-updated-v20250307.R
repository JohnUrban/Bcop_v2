...
setwd("~/Google-Drives/dr.john.urban/Carnegie/Projects/Bcop_v2_release/hic/inversion-X-aln/laveAnalysis/Oct2024/02-updated-params-narrow-peaks/male/update-20250307/")
...
source("~/software/Bcop_v2/code/SCOPE/02-SCOPE/01-functions/SCOPE-v1.20250307.R")
