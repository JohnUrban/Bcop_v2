setwd("~/Google-Drives/dr.john.urban/Carnegie/Projects/Bcop_v2_release/hic/inversion-X-aln/laveAnalysis/Oct2024/01-orig-params-update/male/")
...
## FOR SOME REASON, THIS LEADS TO A 6.7Mb PLOT THAT ACTS AND LOOKS FUNNY WHEN OPENED OR USED IN KEYNOTE.
##  THE ABOVE PLOT WHICH IS THE SAME EXCEPT SQUARES GIVES A 917KB PLOT THAT WORKS FINE.
##  ***THE WORKAROUND HERE IS TO JUST USE THE ABOVE PLOT WITH INVISIBLE SQUARES.***
...
plotContactGrid.WithClusteredPeakRegions(contactGrid = contactGrid.complete,
                                         ...
                                         transform.fxn = log10.median.normalize,
                                         coltrio=c("violet","darkblue","white","red","yellow"), 
                                         segcol = rgb(0,1,0,0), seglwd = 1, sigdig = 2)
dev.off()
