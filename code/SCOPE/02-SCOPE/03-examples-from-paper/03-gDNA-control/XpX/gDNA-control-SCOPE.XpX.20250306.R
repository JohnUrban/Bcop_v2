...
setwd("~/Google-Drives/dr.john.urban/Carnegie/Projects/Bcop_v2_release/hic/inversion-X-aln/laveAnalysis/Oct2024/otherDots/gDNA-controls/XpX/scope/")
...
xlinks.xpx.gdna.1 <-  read.extra.short.pe(fh="XpX-gDNA-control-rep1-phasemap-q0.extrashort.sorted.X.txt.gz")
xlinks.xpx.gdna.2 <-  read.extra.short.pe(fh="XpX-gDNA-control-rep2-phasemap-q0.extrashort.sorted.X.txt.gz")


## COMBINE
xlinks.xpx.gdna <- rbind(xlinks.xpx.gdna.1,xlinks.xpx.gdna.2) ; 
xlinks.xpx.gdna <- xlinks.xpx.gdna[order(xlinks.xpx.gdna$pos1, xlinks.xpx.gdna$pos2),]
rownames(xlinks.xpx.gdna) <- 1:dim(xlinks.xpx.gdna)[1]
head(xlinks.xpx.gdna)
...
xlinks <- xlinks.xpx.gdna.1
xlinks <- xlinks.xpx.gdna.2
xlinks <- xlinks.xpx.gdna
...
## top 12 SVs
# origParams.adj1.female.alt <- list(MAPQ=10, bx=250000, k=12, gridsize=1024, minpair=1e6, maxpair=NA, quantile_thresh=0.999, minRegionSeparation=1e6, clust.method="h")
