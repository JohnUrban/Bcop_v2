...
setwd("~/Google-Drives/dr.john.urban/Carnegie/Projects/Bcop_v2_release/hic/inversion-X-aln/laveAnalysis/Oct2024/otherDots/X/01-original-12/scope/male/")
...
# origParams.adj1.female <- list(MAPQ=10, bx=250000, k=4, gridsize=1024, minpair=1e6, maxpair=NA, quantile_thresh=0.999, minRegionSeparation=5e6, clust.method="h")

## top 12 SVs
# origParams.adj1.female.alt <- list(MAPQ=10, bx=250000, k=12, gridsize=1024, minpair=2e6, maxpair=NA, quantile_thresh=0.995, minRegionSeparation=1e6, clust.method="h")
# origParams.adj1.female.alt <- list(MAPQ=10, bx=100000, k=12, gridsize=1024, minpair=2e6, maxpair=NA, quantile_thresh=0.995, minRegionSeparation=5e6, clust.method="h")

# top 24 gets all dots of interest
# origParams.adj1.female.alt <- list(MAPQ=10, bx=100000, k=24, gridsize=1024, minpair=2e6, maxpair=NA, quantile_thresh=0.995, minRegionSeparation=5e6, clust.method="h")

## top 25 SVs
# origParams.adj1.female.alt <- list(MAPQ=10, bx=250000, k=25, gridsize=1024, minpair=1e6, maxpair=NA, quantile_thresh=0.999, minRegionSeparation=1e6, clust.method="h")
# origParams.adj1.female.alt <- list(MAPQ=10, bx=100000, k=25, gridsize=1024, minpair=2e6, maxpair=NA, quantile_thresh=0.995, minRegionSeparation=5e6, clust.method="h")

## top 50 SVs
# origParams.adj1.female.alt <- list(MAPQ=10, bx=250000, k=50, gridsize=1024, minpair=1e6, maxpair=NA, quantile_thresh=0.999, minRegionSeparation=1e6, clust.method="h")
origParams.adj1.female.alt <- list(MAPQ=10, bx=100000, k=50, gridsize=1024, minpair=2e6, maxpair=NA, quantile_thresh=0.995, minRegionSeparation=5e6, clust.method="h")
...
useParams <- origParams.adj1.female.alt
