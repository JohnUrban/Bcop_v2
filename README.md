# Bcop_v2
Repository for supplemental files and code associated with the Nov 2022 bioRxiv preprint, and subsequent paper, titled, "Chromosome-scale scaffolding of the fungus gnat genome (Diptera: Bradysia 2 coprophila)." Contains lifted over GFF files for genes and repeats, repeat libraries (FASTA), and files mapping Bcop_v1 to Bcop_v2 (BED and AGP).
...
## EGGS - Entropy of Gene Group Shuffling
```
.
├── code
│   ├── EGGS
...
## SCOPE - Scatter Clusters Of Paired Ends
```
.
├── code
│   ├── SCOPE
...
# Entire Current directory structure:
```
.
├── README.md
├── bcopv1_bcopv2_map
